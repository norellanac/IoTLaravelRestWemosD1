                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                <div class="p-3">
                                    ...
                                    <form action="{{url('users/'.$users->id)}}" method="POST" onsubmit="return checkSubmit();">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{$users->name}}" name="name" required placeholder="Nombre" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" value="{{old('name')}}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" value="{{$users->email}}"name="email" required placeholder="Correo electrónico" class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" value="{{old('email')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
