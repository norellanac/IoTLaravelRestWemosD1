...
<head>
  ...
  <link rel="stylesheet"
    href="{{ asset('plugins/bootstrap-md-datetimepicker/css/bootstrap-material-datetimepicker.css')}}">
...
<body>
  ...
  <div id="wrapper">
    <div class="topbar">
      <div class="topbar-left">
        <a href="{{url('home')}}" class="logo">
          <span><img src="{{ asset('imgs/icons/iot.svg')}}" width="15%" alt=""> IoT</span>
          <i><img src="{{ asset('imgs/icons/iot.svg')}}" alt="" width="35%"></i>
        </a>
      </div>
          ...
          <li class="dropdown notification-list">
            <div class="dropdown notification-list nav-pro-img">
              <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user waves-light" data-toggle="dropdown"
                ...
                <img src="{{ asset('imgs/icons/user.svg')}}" alt="user" class="rounded-square">
              </a>
              <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                @if(auth()->check())
                <a class="dropdown-item" href={{url('/')}}>
                  <i class="mdi mdi-account-circle m-r-5"></i>{{auth()->user()->name}} </a>
                {{--<a class="dropdown-item text-danger" ><i class="mdi mdi-account-circle text-danger"></i><span class="badge badge-info"> {{auth()->user()->getRoleNames()}}
                </span></a> --}}
                @endif
                ...
                <a class="dropdown-item text-danger" href="{{ route('logout') }}" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();"><i class="mdi mdi-power text-danger"></i>Cerrar
                  sesión</a>
    ...
    <div class="content-page">
      ...
      <footer class="footer">
        © 2020 <a href="http://tenxprotocol.com/" target="_blank"><img src="{{ asset('imgs/tenex-informatica.png') }}"
            height="25px"></a>
        <p class="text-muted">Desarollado por <a href="{{url('https://www.facebook.com/alexis.orellana2')}}"> Nery
            Orellana </a></p>
      </footer>
    </div>
  </div>
